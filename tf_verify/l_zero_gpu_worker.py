...
class LZeroGpuWorker:
        ...
        with Listener(address, authkey=b'secret password') as listener:
            ...
            with listener.accept() as conn:
                ...
                while message != 'terminate':
                    ...
                    # verification
                    image, label, strategy, worker_index, number_of_workers, normalization_buckets = conn.recv() #TODO: workers will receive more data
                    coverings = self.__load_coverings(strategy)
                    self.__normalization_buckets = normalization_buckets
    ...
    def verify_group(self, image, label, pixels_group):
        ...
        score = self.__calculate_score(last_layer_bounds, label) if not is_correctly_classified else None
