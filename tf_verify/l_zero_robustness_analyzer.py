...
class LZeroRobustnessAnalyzer:
    ...
    def analyze(self):
        ...
        self.__release_workers(strategy, covering_sizes, w_vector, normalization_buckets, p_vector)
    ...
    def __release_workers(self, strategy, covering_sizes, w_vector, normalization_buckets, p_vector):
