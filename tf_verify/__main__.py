...
/root/OUR_WORK/venv/bin/python /root/OUR_WORK/tf_verify/__main__2.py --domain deeppoly --epsilon 0.01 --k1_lst 70 --failing_origins_num 50 --delta_sub_k 1 --samples_per_sub_k 100 --netname models/128_0.005_94_92_0.5_0.1.onnx --dataset mnist --from_test 0 --num_tests 1 --stats_file stat2
